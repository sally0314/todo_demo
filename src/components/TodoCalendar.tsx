    ...
    return (
        <div className={'w-full'}>
            <div className={'grid grid-cols-7 mx-auto table-auto'}>
                            ...
                            <nav className={'mx-2'}>
                                <ul className={'inline-flex -space-x-px text-sm'}>
                                    <li className={'mx-1'} onClick={goPrev}>
                                        <svg className={'w-[23px] h-[23px] fill-[#8e8e8e]'} viewBox="-30 -30 576 512" xmlns="http://www.w3.org/2000/svg">
                                            <path
                ...
                <div className={'border-t border-l border-slate-300 text-center border-b-0'}>Mon</div>
                <div className={'border-t border-l border-slate-300 text-center border-b-0'}>Tue</div>
                <div className={'border-t border-l border-slate-300 text-center border-b-0'}>Wed</div>
                <div className={'border-t border-l border-slate-300 text-center border-b-0'}>Thu</div>
                <div className={'border-t border-l border-slate-300 text-center border-b-0'}>Fri</div>
                <div className={'border-t border-l border-slate-300 text-center border-b-0'}>Sat</div>
                <div className={'border-t border-l border-slate-300 text-center border-b-0'}>Sun</div>
